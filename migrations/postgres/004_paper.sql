-- Paper trading, Postgres. Mirror of migrations/sqlite/004_paper.sql.
-- Differs only in the identity columns; see 001_init.sql for why every other
-- type is deliberately identical across both engines.
--
